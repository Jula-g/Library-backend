...
public class CreateBookDetailsResponseDto {
    ...
    public CreateBookDetailsResponseDto(String isbn, String title, String author, String publisher, int yearPublished, int availableCopies, BookDetailsDto bookDetails) {
        this.isbn = isbn;
        this.title = title;
        this.author = author;
