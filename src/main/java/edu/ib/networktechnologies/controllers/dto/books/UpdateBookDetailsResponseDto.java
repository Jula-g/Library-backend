...
public class UpdateBookDetailsResponseDto {
    ...
    public UpdateBookDetailsResponseDto(String isbn, String title, String author, String publisher, int yearPublished, int availableCopies, BookDetailsDto bookDetails) {
        this.isbn = isbn;
        this.title = title;
        this.author = author;
    ...
    public UpdateBookDetailsResponseDto() {
    }
